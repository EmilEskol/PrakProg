My exam project was to implement the Berrut B1 rational (24). This is been done and to plots of this
...
"berrutSplines.svg" where it has been tried to extend the span of the data, number of points
 ...
 it self, such as a gaussian or Cos(x), it works well but it gets worse for data with increasing
 value. Lastly i parallelized the sum of the numinator and denominator to speed up the proces.
